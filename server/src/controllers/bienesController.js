...
class BienesController {
  async listar(req, res) {
    try {
      ...
      res
        .status(500)
        .json({ message: "Error al listar bienes.", error: error.message });
    }
  }
  ...
  async listarOperativos(req, res) {
    try {
      ...
      res
        .status(500)
        .json({
          message: "Error al listar bienes operativos.",
          error: error.message,
        });
    }
  }
  ...
  async listarNoAsignados(req, res) {
    try {
      ...
      res
        .status(500)
        .json({
          message: "Error al listar bienes no asignados.",
          error: error.message,
        });
    }
  }
  ...
  async bienesNoIdentificados(req, res) {
    try {
      ...
      res
        .status(500)
        .json({
          message: "Error al listar bienes no identificados.",
          error: error.message,
        });
    }
  }
  ...
  async validarNumeroBienUnico(req, res) {
    try {
      ...
      res
        .status(500)
        .json({
          message: "Error al validar numero único",
          error: error.message,
        });
    }
  }
  ...
  async obtenerPorId(req, res) {
    try {
      ...
      res
        .status(500)
        .json({
          message: "Error al obtener el bien por ID.",
          error: error.message,
        });
    }
  }
  ...
  async obtenerMetricasPorCategoria(req, res) {
    try {
      ...
      res
        .status(500)
        .json({
          message: "Error al obtener bienes por categoría.",
          error: error.message,
        });
    }
  }
  ...
  async obtenerMetricasPorEstatus(req, res) {
    try {
      ...
      res
        .status(500)
        .json({
          message: "Error al obtener el estado de los bienes.",
          error: error.message,
        });
    }
  }
  ...
  async obtenerResumenMetricas(req, res) {
    try {
      ...
      res
        .status(500)
        .json({ message: "Error al obtener métricas.", error: error.message });
    }
  }
  ...
  async obtenerMetricasPorDependencia(req, res) {
    try {
      ...
      res
        .status(500)
        .json({
          message: "Error al obtener métricas por dependencia.",
          error: error.message,
        });
    }
  }
  ...
  async metricaDisponibilidadPorDependencia(req, res) {
    try {
      ...
      res
        .status(500)
        .json({
          message: "Error al listar dependencias con disponibilidad.",
          error: error.message,
        });
    }
  }
  ...
  async crear(req, res) {
    try {
      ...
      res
        .status(500)
        .json({ message: "Error al crear bien.", error: error.message });
    }
  }
  ...
  async actualizar(req, res) {
    try {
      ...
      res
        .status(500)
        .json({ message: "Error al actualizar bien", error: error.message });
    }
  }
  ...
  async generarReporte(req, res) {
    try {
      ...
      const buffer = await BienesServices.generarReporte(idDependencia);
      res.setHeader(
        "Content-Type",
      ...
      res.setHeader(
        "Content-Disposition",
        "attachment; filename=reporte_bienes.xlsx",
      );
      res.send(buffer);
    } catch (error) {
      res
