...
-- ==============================================================================
-- 1. % Bienes No Identificados (%IBNI) - ID: 7 (Mensual)
-- ==============================================================================
(7, '10-2025', 18.00, '2025-10-31', '{"total": 250, "cantidad": 45}'),
(7, '11-2025', 15.50, '2025-11-30', '{"total": 264, "cantidad": 41}'),
(7, '12-2025', 12.00, '2025-12-31', '{"total": 266, "cantidad": 32}'),
(7, '01-2026', 9.50,  '2026-01-31', '{"total": 284, "cantidad": 27}'),
(7, '02-2026', 7.50,  '2026-02-28', '{"total": 293, "cantidad": 22}'),
(7, '03-2026', 6.20,  '2026-03-23', '{"total": 306, "cantidad": 19}'),
-- ==============================================================================
-- 2. % Bienes en Estado Operativo (%IBEO) - ID: 6 (Mensual)
-- ==============================================================================
(6, '10-2025', 95.00, '2025-10-31', '{"total": 250, "cantidad": 237}'),
(6, '11-2025', 92.50, '2025-11-30', '{"total": 264, "cantidad": 244}'),
(6, '12-2025', 85.00, '2025-12-31', '{"total": 266, "cantidad": 226}'),
(6, '01-2026', 89.00, '2026-01-31', '{"total": 284, "cantidad": 252}'),
(6, '02-2026', 94.00, '2026-02-28', '{"total": 293, "cantidad": 275}'),
(6, '03-2026', 96.50, '2026-03-23', '{"total": 306, "cantidad": 295}'),
-- ==============================================================================
-- 3. Índice de Crecimiento Mensual (ICMI) - ID: 8 (Mensual)
-- ==============================================================================
(8, '10-2025', 250, '2025-10-31', null),
(8, '11-2025', 264, '2025-11-30', null),
(8, '12-2025', 266, '2025-12-31', null),
(8, '01-2026', 284, '2026-01-31', null),
(8, '02-2026', 293, '2026-02-28', null),
(8, '03-2026', 306, '2026-03-23', null),
-- ==============================================================================
-- 4. Otros Indicadores Mensuales (Últimos 3 meses)
-- ==============================================================================
-- IBODP (ID 7)
(9, '01-2026', 85.00, '2026-01-31', '{"total": 20, "cantidad": 17}'),
(9, '02-2026', 90.00, '2026-02-28', '{"total": 10, "cantidad": 9}'),
(9, '03-2026', 95.00, '2026-03-23', '{"total": 40, "cantidad": 38}'),
-- ITPMB (ID 8)
(10, '01-2026', 5,  '2026-01-31', '{"cantidad": 20}'),
(10, '02-2026', 5,  '2026-02-28', '{"cantidad": 10}'),
(10, '03-2026', 4,  '2026-03-23', '{"cantidad": 40}'),
-- %ITDB (ID 9)
(11, '01-2026', 1.50,  '2026-01-31', '{"total": 284, "cantidad": 4}'),
(11, '02-2026', 0.50,  '2026-02-28', '{"total": 293, "cantidad": 1}'),
(11, '03-2026', 2.10,  '2026-03-23', '{"total": 306, "cantidad": 6}'),
-- %IDD (ID 10)
(12, '01-2026', 15.00, '2026-01-31', '{"total": 4, "cantidad": 1}'),
(12, '02-2026', 12.00, '2026-02-28', '{"total": 1, "cantidad": 0}'),
(12, '03-2026', 18.00, '2026-03-23', '{"total": 6, "cantidad": 1}'),
-- ==============================================================================
...
-- ICP (ID 13)
(13, 'II-2025', 75.00, '2025-12-31', '{"cantidad": 15, "total": 20}'),
(13, 'I-2026', 82.00, '2026-03-23', '{"cantidad": 18, "total": 22}'),
-- IPS (ID 14)
(14, 'II-2025', 85.00, '2025-12-31', '{"cantidad": 42, "total": 49}'),
(14, 'I-2026', 88.00, '2026-03-23', '{"cantidad": 45, "total": 51}');