...
<template>
  <div class="flex flex-col justify-between gap-2 p-2.5 min-w-0 min-h-34 snap-center rounded-xl bg-slate-50/50 border border-slate-200 ring-2 ring-inset ring-white dark:ring-slate-850 dark:bg-slate-800/75 dark:border-slate-700 shadow-xs">
